...
function initProjectActions(){$("#projectActionInput").keyup(function(e){e.keyCode==ENTER_KEY&&projectActionEnterPressed()})}$(document).ready(function(){document.onkeydown=checkKey,$.ajax({type:"GET",url:"api/projects"}).done(function(e){projects=e,$("#header").html(generateHeaderMarkup(projects.projects)),$("#editNewProjectNameInput").keyup(function(e){e.keyCode==ENTER_KEY&&createNewProject()})})});
...
function generateHeaderMarkup(e){var t='<select id="projectSelector" class="form-control" onchange="selectProject()">';t+='<option id="selectProjectOption" value="0">Select Project...</option>';for(var n=0;n<e.length;n++)t+='<option value="'+e[n].id+'">'+e[n].name+"</option>";return t+='<option id="newProjectOption" value="-1">Create New Project...</option></select>',t+='<input id="editNewProjectNameInput" class="form-control"></input>',t+='<a href="#" class="btn btn-default" style="float:right" onclick="saveToDatabase()">Save to Database</a>'}function generateMarkup(){var e='<table id="treeTable"><tr id="headerRow"><th><div id="projectActionContainer">';e+='<select id="projectActionSelector" class="form-control" onchange="handleProjectAction()"><option value="blank"></option>',e+='<option value="addField">Add Field</option>',e+="</select>",e+='<input id="projectActionInput" class="form-control"></input>',e+="</div></th>";for(var t=0;t<tree.fields.length;t++)e+=getFieldHeaderMarkup(tree.fields[t].name,t);e+="</tr>";for(var n=0;1>n;n++)for(var t=0;t<tree.nodes.length;t++)e+=addRow(tree.nodes[t],0,"",0);return e+="</table>"}function addRow(e,t,n,i){var o="",a="nodeRow depth"+t+" expanded parent"+i+" "+n,l=e.id,d='<div class="redips-drag pull-right"><i class="glyphicon glyphicon-move"></i></div>',r='<a href="#" class="pull-right btn btn-danger btn-xs" style="margin:2px 0px 0px 0px" onclick="deleteNode(this)"><i class="glyphicon glyphicon-remove"></i></a>',s='<a href="#" class="pull-right btn btn-info btn-xs" style="margin:2px 4px 0px 0px" onclick="copyNode(this)"><i class="glyphicon glyphicon-plus"></i></a>',c='<a id="expandID'+l+'" href="#" style="margin-left:'+10*t+'px" onclick="toggle(this)" class="btn btn-xs show-expand"><span id="icon'+l+'" class="glyphicon glyphicon-chevron-down iconp'+i+'"></span></a>',p='<a id="expandID'+l+'" href="#" style="margin-left:'+10*t+'px" onclick="toggle(this)" class="btn btn-xs hide-expand"><span id="icon'+l+'" class="glyphicon glyphicon-chevron-down iconp'+i+'"></span></a>';o+='<tr id="rowid'+l+'" class="'+a+'"><td class="redips-rowhandler cell">',o+=r+s+d,o+=e.nodes&&e.nodes.length>0?c:p,o+='<input id="nodeInput'+e.id+'" class="node" type="text" value="'+e.name+'" oninput="updateNodeName(this)"/></td>';for(var u=0;u<tree.fields.length;u++)o+=e.values&&e.values[tree.fields[u].name]?getFieldCellMarkup(tree.fields[u].name,l,e.values[tree.fields[u].name]):getFieldCellMarkup(tree.fields[u].name,l);if(o+="</tr>",e.nodes&&e.nodes.length>0)for(var u=0;u<e.nodes.length;u++)o+=addRow(e.nodes[u],t+1,n+" ancestor"+l,l);return o}function addColumn(e){$("#headerRow").append(getFieldHeaderMarkup(e,tree.fields.length)),$(".nodeRow").each(function(t,n){$(n).append(getFieldCellMarkup(e,n.id.replace("rowid","")))})}function getFieldHeaderMarkup(e,t){return'<th id="colHeader'+e+'" class="header"><div class="moveColGrip"></div><input id="colHeaderInput'+e+'" class="fieldNameInput" type="text" value="'+e+'"/><div id="grip'+t+'" class="resizeColGrip" onmousedown="startResize(event, this)"></div></th>'}function getFieldCellMarkup(e,t,n){var i="";return n&&(i=n),'<td class="cell"><input class="fieldInput fieldInput'+e+'" type="text" id="'+e+t+'" value="'+i+'" oninput="updateFieldValue(\''+e+"', '"+t+"')\"/></td>"}function getAssemblyMarkup(e,t,n){var i=findNodeInTree(e),o=findParentInTree(e);return addRow(i,n,"ancestor"+o.id,o.id)}
function displayProject(){$("#redips-drag").html(generateMarkup()),redips.init(),initProjectActions()}function projectActionEnterPressed(){if("addField"==$("#projectActionSelector").val()){var e=$("#projectActionInput").val();tree.fields.push({name:e}),addColumn(e),$("#projectActionInput").hide(),$("#projectActionSelector").val("blank"),refreshDataModelDisplay()}}function createNewProject(){$("#selectProjectOption").remove();var e=$("#editNewProjectNameInput").val();$("#editNewProjectNameInput").hide();var t=projects.nextProjectID.toString(),o=document.createElement("option");o.text=e,o.value=t,$(o).insertBefore("#projectSelector option:nth-child("+$("#projectSelector").length+")"),$("#projectSelector").val(t),$.ajax({type:"POST",url:"/api/addProject?projectName="+e}),tree={projectID:t,projectName:e,version:1,nextNodeID:2,fields:[],nodes:[{id:1,name:e,nodes:[]}]},displayProject(),saveToDatabase(),refreshDataModelDisplay()}var handleProjectAction=function(){"addField"==$("#projectActionSelector").val()&&($("#projectActionInput").val("Type New Field Name and Press Enter to Create"),$("#projectActionInput").show().focus().select())};
